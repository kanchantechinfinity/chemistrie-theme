...
(function () {
  ...
  gsap.from(".hero__cta-row > *", { y: 20, duration: 0.7, delay: 0.5, ease: "power2.out", stagger: 0.1 });
  gsap.from(".hero__trust > *", { y: 16, duration: 0.7, delay: 0.7, ease: "power2.out", stagger: 0.08 });
  ...
  if (window.ScrollTrigger) {
    gsap.from(".pstate__body", {
      opacity: 0, x: -50, duration: 1, delay: 0.25, ease: "power2.out",
